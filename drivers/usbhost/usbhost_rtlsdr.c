/****************************************************************************
 * drivers/usbhost/usbhost_rtlsdr.c
 *
...
/* This format is used to construct the /dev/rtlsdr[n] device driver path.  It
 * defined here so that it will be used consistently in all places.
 */

#define DEV_FORMAT          "/dev/rtlsdr%c"
...
#define USBHOST_ALLFOUND    (USBHOST_IFFOUND | USBHOST_BINFOUND)
...
struct usbhost_state_s
{
  ...
  char                    devchar;      /* Character identifying the /dev/rtlsdr[n] device */
...
static const struct usbhost_id_s g_id =
{
  ...
  USB_CLASS_VENDOR_SPEC,  /* subclass */
  USB_CLASS_VENDOR_SPEC,  /* proto */
  0x0bda,  /* vid      */
  0x2838   /* pid      */
};
/* This is the USB host storage class's registry entry */

static struct usbhost_registry_s g_rtlsdr =
{
  NULL,                   /* flink    */
...
/* This is a bitmap that is used to allocate device names /dev/rtlsdra-z. */
        ...
        case USB_DESC_TYPE_INTERFACE:
          {
             ...
             * There are two interfaces on this device.
             */
...
int usbhost_rtlsdrinit(void)
{
  /* Perform any one-time initialization of the class implementation */

  /* Advertise our availability to support (certain) devices */

  return usbhost_registerclass(&g_rtlsdr);
}
